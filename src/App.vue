        ...
        async getToolsConfiguration() {
            ...
            .then((response) => {
                try {
                    ...
                    console.log('🚀 config_data', all_data);
                    console.log('🚀 config_data_pivots', this.data_pivots);
            ...
            // pivots
            url = `${this.base_url}/entity/info/${this.default_info}?page=1&set_alias=alias`;
            await axios.get(url)
            .then((response) => {
                this.all_info = response.data.content;
                console.log('🚀 config_info_pivots', this.all_info);
            })
            .catch((error) => {
                console.error(error);
            })
